...
public class Cor {
	...
	//Reset Color
			...
			// Text Color High Intensity - brilho aumentado
			...
			// Text Color Bold High Intensity - mais claro e em negrito
			...
			// Background Color - pintar atrás da letra
